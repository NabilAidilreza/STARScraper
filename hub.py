from ntu_extract_timetable import print_table, create_timetable_list, compile_mods, get_today, get_weekly, get_course_info, get_all_mods, check_what_week_day,generate_timeline
